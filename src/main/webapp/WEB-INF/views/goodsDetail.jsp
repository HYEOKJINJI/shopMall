					...
					<li>
						<div class="comment_wrap">
							<div class="reply_top">
								...
								<span class="rating_span">평점 : <span class="rating_value_span"></</span>점</span>
...
$(document).ready(function(){
	...
	$(".point_span").text(point.toLocaleString());
	...
	$.getJSON("/reply/list", {bookId : bookId}, function(obj){
		...
		if(obj.list.length === 0){
			$(".reply_not_div").html("<soan>리뷰가 없습니다.<span>");
			...
			$(list).each(function(i,obj){
				...
				/* 평점 */
				reply_list += "<span class='rataing_span'> 평점 : <span class='rating_value_span'>" + obj.rating + '</span>점</span>';
	...
	$(".plus_btn").on("click", function(e){
		...
		let qCount = $(".quantity_input").val(++quantity);

		let salePrice = "${goodsInfo.bookPrice - (goodsInfo.bookPrice * goodsInfo.bookDiscount)}";
		let point = salePrice*0.05*qCount.val();
		point = Math.floor(point);
		$(".point_span").text(point.toLocaleString());
