			...
			<div class="content_main">
				...
				<div class="orderGoods_div">
					...
					<div class="goods_kind_div">
						주문 상품 <span class="goods_kind_div_kind"></span>종 <span class="goods_kind_div_count"></span>개
					</div>
					<!-- 상품 테이블 -->
					...
					<div class="total_info_price_div">
						<ul>
							...
							<li>
								...
								<span class="delivery_price_span">30000</span>원
							</li>
							<li>
							...
							<li class="point_li">
								...
								<span class="totalPoint_span">7600원</span>
							</li>
						</ul>
					</div>
					<!-- 버튼 영역 -->
	...
	function execution_daum_address(){
		   ...
		   new daum.Postcode({
		        oncomplete: function(data) {
	                ...
	                $(".address3_input").attr("placeholder", "상세정보");
